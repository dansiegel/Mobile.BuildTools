...
namespace Xamarin.Android.Tools
{
    internal class AndroidManifest
    {
        ...
        public static AndroidManifest Create(string packageName, string appLabel)
        {
            return new AndroidManifest(XDocument.Parse(
...
<manifest xmlns:android=""http://schemas.android.com/apk/res/android"" android:versionCode=""1"" android:versionName=""1.0"">
  ...
  <application android:label="""">
        ...
        public static AndroidManifest Load(string filename)
        {
            if (filename == null)
        ...
        public static AndroidManifest Load(XDocument doc)
        {
            if (doc == null)
                throw new ArgumentNullException(nameof(doc));

            return new AndroidManifest(doc);
        }
        ...
        int? ParseSdkVersion(XAttribute attribute)
        {
            ...
            if (string.IsNullOrEmpty(version))
                return null;
            if (!int.TryParse(version, out var vn))
            {
                return 28;
            }
            return vn;
