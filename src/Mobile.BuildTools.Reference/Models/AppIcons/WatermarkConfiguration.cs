...
namespace Mobile.BuildTools.Models.AppIcons
{
    public class WatermarkConfiguration
    {
        ...
        [JsonProperty("sourceFile", Required = Required.AllowNull, NullValueHandling = NullValueHandling.Ignore)]
        ...
        [JsonProperty("colors", Required = Required.AllowNull, NullValueHandling = NullValueHandling.Ignore)]
        public IEnumerable<string> Colors { get; set; }

        [Description("Specifies the watermark position.")]
        [JsonProperty("position", Required = Required.AllowNull, NullValueHandling = NullValueHandling.Ignore)]
        ...
        [JsonProperty("textColor", Required = Required.AllowNull, NullValueHandling = NullValueHandling.Ignore)]
        public string TextColor { get; set; }

        [Description("The Font Family name if you want to use a custom font.")]
        [JsonProperty("fontFamily", Required = Required.AllowNull, NullValueHandling = NullValueHandling.Ignore)]
        public string FontFamily { get; set; }

        [Description("Have a custom font you want to use, you can provide the file path to the Font File.")]
        [JsonProperty("fontFile", Required = Required.AllowNull, NullValueHandling = NullValueHandling.Ignore)]
        public string FontFile { get; set; }

        [Description("The opacity to use for the Watermark or Banner.")]
        [JsonProperty("opacity", Required = Required.AllowNull, NullValueHandling = NullValueHandling.Ignore)]
