...
namespace Mobile.BuildTools.Models
{
    ...
    public class BuildToolsConfig
    {
        ...
        [JsonProperty("appConfig", NullValueHandling = NullValueHandling.Ignore)]
        ...
        [JsonProperty("artifactCopy", NullValueHandling = NullValueHandling.Ignore)]
        ...
        [JsonProperty("automaticVersioning", NullValueHandling = NullValueHandling.Ignore)]
        ...
        [JsonProperty("releaseNotes", NullValueHandling = NullValueHandling.Ignore)]
        public ReleaseNotesOptions ReleaseNotes { get; set; }

        [Obsolete]
        [Description("Note: This is obsolete, please use `appSettings`.")]
        [JsonProperty("projectSecrets", NullValueHandling = NullValueHandling.Ignore)]
        ...
        [JsonProperty("appSettings", NullValueHandling = NullValueHandling.Ignore)]
